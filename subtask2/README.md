...
Below is the results of the of the various MLMs for this given subtask (Types Subtask), based on the average F1 score:

![Results Table Header](./02-ResultsTableHeaderMLM.png)
![Results Table Data](./02-ResultsTableDataMLM.png)

And here are the results for the LLMs:

![Results Table Header](./02-ResultsTableLLM.png)